...
@objc public extension Target {
    ...
    /// The provided session Id is persisted in the SDK for a period defined by `target.sessionTimeout` configuration setting. If no Target requests are made during that time,
    /// a new sessionId is generated by the SDK.
    ///
    ...
    /// Retrieves the SDK generated session Id. The session Id is generated locally in the SDK upon intial Target request and
